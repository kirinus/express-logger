      ...
      `;
        ...
        describe('formatLogstash', () => {
            ...
            test('with object', () => {
                ...
                expect(src_1.formatLogstash().transform({ level: 'info', message: { description: 'unit-test' } })).toMatchObject(expectedPrintfFormat);
            });
            test('without a message', () => {
                const expectedPrintfFormat = { level: 'info', [Symbol('message')]: '{"@fields":{"level":"info"}}' };
